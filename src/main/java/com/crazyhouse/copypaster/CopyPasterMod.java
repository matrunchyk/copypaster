...
public class CopyPasterMod implements ModInitializer {
    ...
    public static long SESSION_TIMEOUT_MS = 60_000L;
    ...
    public void onInitialize() {
        ...
        STORAGE.setMaxVolume(CopyPasterServerConfig.maxVolume());
        SESSION_TIMEOUT_MS = CopyPasterServerConfig.sessionTimeoutMs();

        CopyPasterNetworking.registerPayloadTypes();

        ServerPlayNetworking.registerGlobalReceiver(CopyRegionPayload.TYPE, (payload, context) ->
                context.server().execute(() ->
                        CopyPasterCommands.handleCopyRegion(context.player(), payload)));
